  ...
  items: [
    {
      ...
      value: 'On',
      why: 'Reduces render queue without aggressive CPU overhead.',
    },
    {
      id: 'nv-power-mode',
      setting: 'Power Management Mode',
      value: 'Prefer Maximum Performance',
      why: 'Prevents GPU downclocking mid-game.',
    },
    {
  ...
  items: [
    {
      ...
      setting: 'Low Latency Mode',
      value: 'Ultra',
      why: 'Minimum render queue. CPU waits for GPU. Lowest latency.',
    },
    {
      id: 'nv-pro-power-mode',
      setting: 'Power Management Mode',
      value: 'Prefer Maximum Performance',
      why: 'No downclocking, ever.',
    },
    {
  ...
  items: [
    {
      ...
      setting: 'Low Latency Mode',
      value: 'On',
      why: 'Ultra can cause frame drops during encoding.',
    },
    {
  ...
  items: [
    {
      ...
      setting: 'Low Latency Mode',
      value: 'Off for benchmarks, Ultra for latency tests',
      why: 'Off = consistent frametimes for comparisons.',
    },
    {
